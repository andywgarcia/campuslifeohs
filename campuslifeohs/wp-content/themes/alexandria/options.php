...
function optionsframework_options() {
	...
	$options[] = array( "name" => "country13",
		...
		$options[] = array( "name" => __("Welcome Section", 'alexandria' ),
					...
					$options[] = array( "name" => __("Show Welcome Section?", 'alexandria' ),
										"desc" => __("Select yes if you want to Welcome section.", 'alexandria' ),
										"id" => "show_eone_welcome_section",
										"std" => "true",
										"type" => "select",
										"class" => "mini", //mini, tiny, small
										"options" => $magpro_slider_start);								
					...
					$options[] = array( "name" => __("Headline", 'alexandria' ),
										"desc" => __("Enter the headline", 'alexandria' ),
										"id" => "eone_welcome_headline",
										"type" => "text");		
										
					$options[] = array( "name" => __("Welcome text", 'alexandria' ),
										"desc" => __("Enter the welcome text. You can use ul, li, strong, a, br, em html tags.", 'alexandria' ),
										"id" => "eone_welcome_text",
										"type" => "textarea");														

										
		$options[] = array( "type" => "groupcontainerclose");	
		
		$options[] = array( "name" => __("Latest Products Section", 'alexandria' ),
							"type" => "groupcontaineropen");
							
					$options[] = array( "name" => __("Heading", 'alexandria' ),
										"desc" => __("Enter the heading", 'alexandria' ),
										"id" => "eone_latest_section_headline",
										"type" => "text");	
										
					$options[] = array( "name" => __("How many Products?", 'alexandria' ),
										"desc" => __("Enter a number", 'alexandria' ),
										"id" => "eone_latest_section_num",
										"type" => "text");	
