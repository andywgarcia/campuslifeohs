...
{
    // default connection
    public static $dbname = 'campusli_prod'; // Your database name
    public static $dbuser = 'campusli_test'; // Your database username
    public static $dbpass = 'campuslife4LIFE'; // // Your database password
